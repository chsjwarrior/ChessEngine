...
Bitmap attacks::getRookAttacks(const Bitmap allPieces, const File file, const Rank rank, const Bitmap squareBitmap) {
	const Bitmap reverseSquareBitmap = reverse(squareBitmap);
...
Bitmap attacks::getKnightAttacks(const Bitmap squareBitmap) {
...
Bitmap attacks::getKingAttacks(const Bitmap squareBitmap) {
